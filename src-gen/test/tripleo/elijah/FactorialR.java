...
//		buf.append_nl("} // close select ("+node.hdr_node.left.genName+")"); // TODO left was expr
	...
	@Deprecated
	private void GenReturnAgnSimpleInt(final @NotNull CompilerContext cctx, final @NotNull ReturnAgnSimpleIntNode rasin,
	                                   final @NotNull GenBuffer gbn) {
		final TextBuffer buf = gbn.moduleBufImpl(cctx.module());
		buf.append("vsr = ");
	...
	public class Transform1 implements Transform/*<ArgumentNode>*/ {
		...
		@Override
		public void transform(final Object aO, final DefaultBuffer aDefaultBuffer) {
			transform((ArgumentNode) aO, aDefaultBuffer);
		}
	}
