...
public class BldBuild extends WebProject {
	...
	public BldBuild() {
		...
		final String V_activej_version = "6.0-beta2";
		...
		scope(compile)
				...
				.include(dependency("org.jetbrains", "annotations", "26.1.0"))
	...
	public static void main(final String[] args) {
		final BldBuild build = new BldBuild();
		build.start(args);
