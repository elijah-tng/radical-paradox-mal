...
public class GenerateFunctions {
	...
	public void generateFromEntryPoints(final EntryPointList epl, final DeducePhase deducePhase) {
		epl.generate(this, deducePhase, () -> phase.getWm());
	}
	...
	/**
	 * See {@link WorkJob#run(WorkManager)}
	 *
	 * @param aClassStatement
	...
	InstructionArgument simplify_expression(
		...
		switch (expressionKind) {
			...
			case CAST_TO: {
				...
				@NotNull final TypeTableEntry tte_index =
						...
						.then(
								new DoneCallback<GenType>() { // TODO should this be done here?
									...
									public void onDone(final GenType result) {
										@NotNull final TypeTableEntry tte = gf.newTypeTableEntry(
