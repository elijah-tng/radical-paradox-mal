...
public final class KeyWithWorkerData {
	...
	public KeyWithWorkerData(final Key<?> key) {
		this(key, null, -1);
	}

	public KeyWithWorkerData(final Key<?> key, @Nullable final WorkerPool pool, final int workerId) {
		this.key      = key;
		this.pool     = pool;
	...
	public boolean equals(final Object o) {
		...
		final KeyWithWorkerData that = (KeyWithWorkerData) o;
