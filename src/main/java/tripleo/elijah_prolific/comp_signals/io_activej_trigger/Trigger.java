...
public final class Trigger {
	...
	Trigger(final Severity severity, final String component, final String name, final Supplier<TriggerResult> triggerFunction) {
	...
	public static Trigger of(final Severity severity, final String component, final String name, final Supplier<TriggerResult> triggerFunction) {
